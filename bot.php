...
function createPaletteImage($color, GenerationAlgorithms $generationAlgorithm, $number_of_colors)
{
...
function generateColorMessage($interaction, GenerationAlgorithms $generationAlgorithm)
{
	...
	$image = createPaletteImage($color, $generationAlgorithm, $number_of_colors);
